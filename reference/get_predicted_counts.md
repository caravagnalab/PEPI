# Get posterior-predictive counts (z\_\*\_pred) with observed counts joined in.
...
get_predicted_counts(x)
#> # A tibble: 18 × 9
#>    group    id    sampling_time epistate quantity      mean      lower     upper
#>    <chr>    <chr>         <dbl> <chr>    <chr>        <dbl>      <dbl>     <dbl>
#>  1 clade_wt c1                3 +        NA           2.05     0.155     8.53e+0
#>  2 clade_wt c1                3 -        NA           2.13     0.163     9.88e+0
#>  3 clade_wt c1                6 +        NA          59.8      4.96      2.88e+2
#>  4 clade_wt c1                6 -        NA         170.      12.6       7.87e+2
#>  5 clade_wt c1                9 +        NA        1944.     151.        9.87e+3
#>  6 clade_wt c1                9 -        NA        6668.     428.        3.57e+4
#>  7 driver   KRAS              3 +        NA           0.106    0.00484   5.34e-1
#>  8 driver   KRAS              3 -        NA           3.07     0.271     1.13e+1
#>  9 driver   KRAS              6 +        NA           6.82     0.338     3.31e+1
#> 10 driver   KRAS              6 -        NA         104.       7.69      5.47e+2
#> 11 driver   KRAS              9 +        NA         650.      23.4       3.79e+3
#> 12 driver   KRAS              9 -        NA        4100.     229.        1.90e+4
#> 13 wt       NA                3 +        NA           1.82     0.134     8.11e+0
#> 14 wt       NA                3 -        NA          17.8      1.44      7.71e+1
#> 15 wt       NA                6 +        NA          73.8      4.00      3.09e+2
#> 16 wt       NA                6 -        NA         524.      35.6       2.65e+3
#> 17 wt       NA                9 +        NA        3261.     118.        1.48e+4
#> 18 wt       NA                9 -        NA       23417.    1115.        1.09e+5
#> # ℹ 1 more variable: z_observed <dbl>
# }
```
