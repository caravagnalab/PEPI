# Get posterior-predictive fractions (frac\_\*\_pred) with observed fractions joined in.
...
#>  1 clade_wt c1                3 +        NA       0.475  0.0903       0.878
#>  2 clade_wt c1                3 -        NA       0.525  0.122        0.910
#>  3 clade_wt c1                6 +        NA       0.273  0.0195       0.663
#>  4 clade_wt c1                6 -        NA       0.727  0.337        0.981
#>  5 clade_wt c1                9 +        NA       0.227  0.0122       0.620
#>  6 clade_wt c1                9 -        NA       0.773  0.380        0.988
#>  7 driver   KRAS              3 +        NA       0.0262 0            0.206
#>  8 driver   KRAS              3 -        NA       0.974  0.794        1    
#>  9 driver   KRAS              6 +        NA       0.0613 0.0000000281 0.410
#> 10 driver   KRAS              6 -        NA       0.939  0.590        1.000
#> # ℹ 14 more rows
#> # ℹ 1 more variable: frac_observed <dbl>
# }
```
