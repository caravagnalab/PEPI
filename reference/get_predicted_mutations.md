# Get posterior-predictive mutation counts (m\_\*\_pred) with observed counts joined in.
...
get_predicted_mutations(x)
#> # A tibble: 3 × 7
#>   group    id    event  mean lower upper m_observed
#>   <chr>    <chr> <int> <dbl> <dbl> <dbl>      <int>
#> 1 clade_wt c1       NA  569.  495.  645.        584
#> 2 driver   KRAS     NA 1068.  985  1163.       1075
#> 3 global   NA       NA 1178.  984  1380.       1081
# }
```
